...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println(CYAN + " [4] " + RESET + "GEO Quizzer");

            System.out.println(CYAN + " [5] " + RESET + "Exit");
            ...
            String programName = "";
            if (choice.equals("1")) {
                programName = "GEO Grocery ShopperMart POS";
            } else if (choice.equals("2")) {
                programName = "GEO Movie Rental Registration";
            } else if (choice.equals("3")) {
                programName = "GEO Devil Fruit Registration";
            ...
            try {
                if (choice.equals("1")) {
                    final_program.grocery.Main.main(args);
                } else if (choice.equals("2")) {
                    final_program.movieregistration.MovieRegistration.main(args);
                } else if (choice.equals("3")) {
                    final_program.devilfruitregistration.Main.main(args);
                } else if (choice.equals("4")) {
                    final_program.quizzer.GameUI.main(args);
                }
            } catch (Exception e) {
